...
public class DietprocessActivity5 extends AppCompatActivity {
...
//         bm2 = BitmapFactory.decodeByteArray(arr2,0,arr2.length);
        ...
        imageView.setImageBitmap(cropped4);
        ...
        uploadImage(cropped4);

        direct_typing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder ad = new AlertDialog.Builder(DietprocessActivity5.this);

                ad.setTitle("Food Classification");       // 제목 설정
                ad.setMessage("Type name of food");   // 내용 설정

                final AutoCompleteTextView et = new AutoCompleteTextView(DietprocessActivity5.this);
                ad.setView(et);
...
//                        byte[] arr6 = in3.getByteArrayExtra("picture_process5");
                        ...
                        Intent topintent = new Intent(DietprocessActivity5.this ,DietprocessActivity6.class);
...
//                        topintent.putExtra("picture_process5",arr6);
                        ...
                        topintent.putExtra("choice_food4", value);
    ...
    private class LabelDetectionTask extends AsyncTask<Object, Void, ArrayList<FoodRecognition>> {
        private final WeakReference<DietprocessActivity5> mActivityWeakReference;
        ...
        protected void onPostExecute(ArrayList<FoodRecognition> result) {
            ...
            DietprocessActivity5 activity = mActivityWeakReference.get();
            ...
            for(int i =0; i< result.size(); i++) {
                ...
                if(check_name.equals("korean food") | check_name.equals("side dish") | check_name.equals("chinese food") | check_name.equals("chinese noodles")) {
                    Log.d("exist bitmap,array?", cropped4.toString()+result.toString());
                    recognize_bitmap(cropped4, result);
                    Log.d("들어옴","1번차례");
                }
            }
            if(result.size() <= 3){
...
//            byte[] arr6 = in3.getByteArrayExtra("picture_process5");
            ...
            if (activity != null && !activity.isFinishing()) {
                ...
                ListViewAdapterFoodRecognition adapter = new ListViewAdapterFoodRecognition(DietprocessActivity5.this, result);
            ...
            listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                public void onItemClick(AdapterView parent, View v, int position, long id) {
                    Intent topintent = new Intent(activity ,DietprocessActivity6.class);
...
//                    topintent.putExtra("picture_process5",arr6);
                    ...
                    topintent.putExtra("choice_food4", strText);
