...
public class DietprocessActivity3 extends AppCompatActivity {
...
//         bm2 = BitmapFactory.decodeByteArray(arr2,0,arr2.length);
        ...
        imageView.setImageBitmap(cropped2);
        ...
        uploadImage(cropped2);


        direct_typing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder ad = new AlertDialog.Builder(DietprocessActivity3.this);

                ad.setTitle("Food Classification");       // 제목 설정
                ad.setMessage("Type name of food");   // 내용 설정

                final AutoCompleteTextView et = new AutoCompleteTextView(DietprocessActivity3.this);
                ad.setView(et);
...
//                        byte[] arr4 = in3.getByteArrayExtra("picture_process3");
...
//                        byte[] arr6 = in3.getByteArrayExtra("picture_process5");
                        ...
                        Intent topintent = new Intent(DietprocessActivity3.this ,DietprocessActivity4.class);
...
//                        topintent.putExtra("picture_process5",arr6);
                        ...
                        topintent.putExtra("choice_food2", value);
    ...
    private class LabelDetectionTask extends AsyncTask<Object, Void, ArrayList<FoodRecognition>> {
        private final WeakReference<DietprocessActivity3> mActivityWeakReference;
        ...
        protected void onPostExecute(ArrayList<FoodRecognition> result) {
            ...
            DietprocessActivity3 activity = mActivityWeakReference.get();
            ...
            for(int i =0; i< result.size(); i++) {
                ...
                if(check_name.equals("korean food") | check_name.equals("side dish") | check_name.equals("chinese food") | check_name.equals("chinese noodles")) {
                    Log.d("exist bitmap,array?", bm2.toString()+result.toString());
                    recognize_bitmap(cropped2, result);
                    Log.d("들어옴","1번차례");
                }
            }
            if(result.size() <= 3){
...
//            byte[] arr6 = in3.getByteArrayExtra("picture_process5");
            ...
            if (activity != null && !activity.isFinishing()) {
                ...
                ListViewAdapterFoodRecognition adapter = new ListViewAdapterFoodRecognition(DietprocessActivity3.this, result);
            ...
            listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                public void onItemClick(AdapterView parent, View v, int position, long id) {
                    Intent topintent = new Intent(activity ,DietprocessActivity4.class);
...
//                    topintent.putExtra("picture_process5",arr6);
                    ...
                    topintent.putExtra("choice_food2", strText);
