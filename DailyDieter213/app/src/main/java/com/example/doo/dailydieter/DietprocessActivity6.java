...
public class DietprocessActivity6 extends AppCompatActivity {
...
//        byte[] arr2 = in3.getByteArrayExtra("picture_process_1");
//        Log.d("arr2's size", String.valueOf(arr2.length));
//         bm2 = BitmapFactory.decodeByteArray(arr2,0,arr2.length);

        imageView = (ImageView)findViewById(R.id.main_image);
        imageView.setImageBitmap(cropped5);
        ...
        uploadImage(cropped5);

        direct_typing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder ad = new AlertDialog.Builder(DietprocessActivity6.this);

                ad.setTitle("Food Classification");       // 제목 설정
                ad.setMessage("Type name of food");   // 내용 설정

                final AutoCompleteTextView et = new AutoCompleteTextView(DietprocessActivity6.this);
                ad.setView(et);
                ...
                ad.setPositiveButton("Type", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        String str1 = in3.getStringExtra("choice_food1");
                        String str2 = in3.getStringExtra("choice_food2");
                        String str3 = in3.getStringExtra("choice_food3");
                        String str4 = in3.getStringExtra("choice_food4");
                        Intent topintent = new Intent(DietprocessActivity6.this ,DietprocessActivity7.class);

                        topintent.putExtra("choice_food1", str1);
                        topintent.putExtra("choice_food2", str2);
                        topintent.putExtra("choice_food3", str3);
                        topintent.putExtra("choice_food4", str4);
                        topintent.putExtra("choice_food5", value);
    ...
    private class LabelDetectionTask extends AsyncTask<Object, Void, ArrayList<FoodRecognition>> {
        private final WeakReference<DietprocessActivity6> mActivityWeakReference;
        ...
        protected void onPostExecute(ArrayList<FoodRecognition> result) {
            ...
            DietprocessActivity6 activity = mActivityWeakReference.get();
            ...
            for(int i =0; i< result.size(); i++) {
                ...
                if(check_name.equals("korean food") | check_name.equals("side dish") | check_name.equals("chinese food") | check_name.equals("chinese noodles")) {
                    Log.d("exist bitmap,array?", cropped5.toString()+result.toString());
                    recognize_bitmap(cropped5, result);
                    Log.d("들어옴","1번차례");
                }
            }
            if(result.size() <= 3){
            ...
            if (activity != null && !activity.isFinishing()) {
                ...
                ListViewAdapterFoodRecognition adapter = new ListViewAdapterFoodRecognition(DietprocessActivity6.this, result);
            ...
            listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                public void onItemClick(AdapterView parent, View v, int position, long id) {
                    Intent topintent = new Intent(activity ,DietprocessActivity7.class);
                    ...
                    topintent.putExtra("choice_food5", strText);
...
//        return message.toString();
    ...
    public static ArrayList<FoodRecognition> checkName(ArrayList<FoodRecognition> al) {
        String[] name_list_remove = new String[]{"food", "cuisine",  "japanese cuisine", "asian food", "dish", "fried food", "chinese noodles", "italian food", "european food",
